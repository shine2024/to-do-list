                ...
                if (taskInputs) {
                    taskInputs.forEach(input => {
                        input.addEventListener('keydown', e => {
                            if (e.key === 'Enter') {
                                if (input.value === '') showError('.error', 'Cannot be edited because its empty..');
...
createBtn.addEventListener('click', (e) => {
    ...
    if (input_value !== '') {
        ...
        showError('.error', 'Cannot be added because its empty..');
    }
});
...
search_btn.addEventListener('click', e => {
    ...
    if (search_value != '') {
        ...
        showError('.error', 'Cannot be searched because its empty..');
